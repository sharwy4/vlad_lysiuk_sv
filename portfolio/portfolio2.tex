...
\role{Частковий розразунок номіналів схем, бібліотека компонентів, повна розводка друкованої плати. Робота під наглядом провідного інженера. Основа кваліфікаційної роботи бакалавра.}
